...
class __TwigTemplate_809442be513a6f0a897bd3d9393303df0ca1c1f6b8e460a64daa4c53348a8b96 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("product_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 27, $this->source); })()), "id", [], "any", false, false, false, 27)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "product/show.html.twig", "C:\\Users\\anas.elhassani\\Desktop\\EnvTest\\templates\\product\\show.html.twig");
    }
}
